...
export const metadata: Metadata = {
  metadataBase: new URL("https://portfolio-one-theta-36.vercel.app"),
  title: {
  ...
  keywords: [
    ...
    "@mavlonov_fakhriddin",
    "Fahriddin",
    "fakhriddin developer",
  ],
  authors: [
    {
      name: "Mavlonov Fakhriddin",
      url: "https://github.com/fahriddin0822",
    },
  ],
  creator: "Mavlonov Fakhriddin",
